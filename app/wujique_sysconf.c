...
/*SPI接口的 tft lcd*/
//const DevLcd DevLcdtTFT	=	{"tftlcd", 		"BusLcdSpi3", 	0x9342, 240, 320};
//const DevLcd DevLcdtTFT	=	{"tftlcd", 		"BusLcdVSpi1CH2", 	0x9342, 240, 320};
//const DevLcd DevLcdtTFT	=	{"tftlcd", 		"BusLcdSpi3", 	0x7735, 128, 128};
