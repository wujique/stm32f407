...
#define zbar_malloc	wjq_malloc
#define zbar_calloc wjq_calloc
#define zbar_realloc wjq_realloc
#define zbar_free	wjq_free 
#else
...
/*÷ÿ∂®“Â∂œ—‘*/
#if 0
#define assert(con) do{ if (!con) printf("Error throw in Line:%d of File:%s\r\n", __LINE__, __FILE__);  while(1); }while(0);
#else 
#define assert(con)
#endif
